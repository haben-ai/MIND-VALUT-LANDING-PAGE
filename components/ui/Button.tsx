    ...
    return (
      <button
        ...
        className={cn(
          ...
          // Variant mappings
          {
            "bg-forest-accent hover:brightness-[1.03] text-[#060C02] border-b-[5px] border-[#62B300] active:border-b-[1px] active:translate-y-[4px]":
              variant === "primary",
            ...
            "text-forest-text-muted hover:text-forest-text-primary hover:bg-forest-surface-2/40 border border-transparent":
              variant === "ghost",
            "bg-forest-accent/10 border border-forest-accent border-b-[4px] hover:bg-forest-accent hover:text-[#060C02] text-forest-accent rounded-full active:translate-y-[3px] active:border-b-[1px]":

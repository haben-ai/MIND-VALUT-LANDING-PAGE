    ...
    return (
      <button
        ...
        className={cn(
          ...
          // Variant mappings
          {
            "bg-forest-accent hover:brightness-[1.03] text-forest-base border-b-[5px] border-[#059669] active:border-b-[1px] active:translate-y-[4px]":
              variant === "primary",
            ...
            "text-forest-text-muted hover:text-forest-text-primary hover:bg-forest-surface-2/40 border border-transparent":
              variant === "ghost",
            "bg-forest-accent/10 border border-forest-accent border-b-[4px] hover:bg-forest-accent hover:text-forest-base text-forest-accent rounded-full active:translate-y-[3px] active:border-b-[1px]":
